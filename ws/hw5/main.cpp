...
int main(int argc, char** argv) {
    ...
    double zetta = 2; // weight on U_att
    double Q_star = 3; // threshold to ignore obstacle
    double eta = 2; // weight on U_rep
    ...
    Visualizer::makeFigure(MyPotentialFunction(prob.q_goal, prob, d_star, zetta, Q_star, eta), prob, 50);
    ...
    HW5::grade<MyGDAlgorithm>("joseph.krauskopf@colorado.edu", argc, argv, d_star, zetta, Q_star, eta);
    return 0;
}